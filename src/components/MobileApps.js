...
const MobileApps = (props) => {
    ...
    return (
        ...
        <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraphy>
            Wether you want an app for your customers, employees, or 
             ...
             style={{backgroundColor: "transparent"}}
              component={Link}
               ...
               onClick={props.setSelectedIndex(3)} >
                <img src={forwardArrow} alt="forward websites Development Page"/>
            </IconButton>
        </Grid>
        </Hidden>
        </Grid>
        ...
        <Grid item>
            ...
            <Typography align={matchesSM ? "center" : undefined} variant="body1" paragraph>
                 with your users than ever before. allows you to extend your reach, reinvent interactions, and 
        ...
        <Grid item>
            <Typography align={matchesSM ? "center" : "right"} variant="body1" paragraph>
                ...
                for phone, Android, and tablets - all at the same time.
            </Typography>
            <Typography align={matchesSM ? "center" : "right"} variant="body1" paragraph>
        ...
        <Grid>
            <img src={swiss} alt="swiss knife army" />
        </Grid>
        </Grid>
        <Grid item container direction="column" alignItems="center" md
